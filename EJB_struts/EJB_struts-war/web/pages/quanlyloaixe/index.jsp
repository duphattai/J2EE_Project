...
<script>
    ...
    $(document).ready(function () {   
        $("#delete").on("click",function(){
            var modal = $("#myModal");
            var mess = modal.find(".mess");
            mess.text("Bạn chắc chắn xóa ?");// gán nội dung thông báo
            
            var button = modal.find(".modal-ok");
            button.data("cauhoiid",$(this).data("id"));                   
            modal.modal('show');   // show thông báo
        });
        ...
        $("#themloaixe1").on("click","button", function () {                              
            $.ajax({
                type: "POST",
                url: '${pageContext.request.contextPath}?method=add',
                processData: true,
                async: true,                                
...
//            var modal = $("#myModal");
//		
//                modal.find(".mess").text("Bạn chắc chắn xóa " + id + "?");
//        });
    });
        function themLoaiXe() {

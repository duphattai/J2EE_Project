...
(function (D, aa) {
    ...
    X = function (a, b, c) {
        ...
        h;
        if (g) b ? (f = g[b] || [
        ], c ? (h = sa(c, f), h > - 1 && (f.splice(h, 1), g[b] = f), d(b, c))  : (e(), g[b] = [
        ]))  : (e(), a.hcEvents = {
        })
    };
    I = function (a, b, c, d) {
    ...
    Array.prototype.filter || (Ba = function (a, b) {
        for (var c = [
        ], d = 0, e = a.length; d < e; d++) b(a[d], d) && c.push(a[d]);
        return c
    });
    x.Fx = pb;
    x.inArray = sa;
    ...
    ma.prototype = {
        ...
        get: function (a) {
            ...
            c = this.rgba,
            d;
            this.stops ? (d = E(b), d.stops = [
            ].concat(d.stops), p(this.stops, function (b, c) {
                d.stops[c] = [
                    d.stops[c][0],
                    b.get(a)
                ]
    ...
    O.prototype = {
        ...
        applyTextShadow: function (a) {
            ...
            g ? this.css(e)  : (this.fakeTS = !0, this.ySetter = this.xSetter, c = [
            ].slice.call(b.getElementsByTagName('tspan')), p(a.split(/\s?,\s?/g), function (a) {
                var d = b.firstChild,
                e,
                f,
                a = a.split(' ');
    ...
    Da.prototype = {
        ...
        buildText: function (a) {
            ...
            !f && !q && !z && e.indexOf(' ') ===
            - 1 ? b.appendChild(A.createTextNode(v(e)))  : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, G && G.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, '<span').replace(/<\/(b|strong|i|em|a)>/g, '</span>').split(/<br.*?>/g)  : [
                e
            ], e = Ba(e, function (a) {
                return a !== ''
            }), p(e, function (e, f) {
                ...
                p(g, function (e) {
                    if (e !== '' || g.length === 1) {
                        ...
                        if (e !== ' ') {
                            ...
                            if (m) {
                                for (var q = e.replace(/([^\^])-/g, '$1- ').split(' '), p = g.length > 1 || f || q.length > 1 && l.whiteSpace !== 'nowrap', G, S, r = [
                                ], t = w(s), u = 1, B = a.rotation, y = e, x = y.length; (p || z) && (q.length || r.length); ) a.rotation = 0,
                                G = a.getBBox(!0),
                                S = G.width,
                                ...
                                k === void 0 && (k = G),
                                z && k ? (x /= 2, y === '' || !G && x < 0.5 ? q = [
                                ] : (y = e.substring(0, y.length + (G ? - 1 : 1) * ua(x)), q = [
                                    y + (m > 3 ? '…' : '')
                                ], s.removeChild(s.firstChild)))  : !G || q.length === 1 ? (q = r, r = [
                                ], q.length && (u++, s = A.createElementNS(Ha, 'tspan'), P(s, {
                                    dy: t,
                                    x: j
    ...
    ha.prototype = {
        ...
        defaultLabelFormatter: function () {
            ...
            if (h) g = Ka(h, this);
             ...
             else if (f && a >= 1000) for (; f-- && g === y; ) c = Math.pow(1000, f + 1),
            a >= c && b * 10 % c === 0 && e[f] !== null && (g = x.numberFormat(b / c, - 1) + e[f]);
            g === y && (g = Q(b) >= 10000 ? x.numberFormat(b, - 1)  : x.numberFormat(b, - 1, y, ''));
            return g
        },
        ...
        setTickInterval: function (a) {
            ...
            if (!g && !e && !l) b.tickInterval = sb(b.tickInterval, null, rb(b.tickInterval), o(d.allowDecimals, !(b.tickInterval > 0.5 && b.tickInterval < 5 && b.max > 1000 && b.max < 9999)), !!this.tickAmount);
        ...
        setTickPositions: function () {
            ...
            if (!b && (b = this.isDatetimeAxis ? this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval, a.units), this.min, this.max, a.startOfWeek, this.ordinalPositions, this.closestPointRange, !0)  : this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max)  : this.getLinearTickPositions(this.tickInterval, this.min, this.max), b.length > this.len && (b = [
                b[0],
                b.pop()
            ]), this.tickPositions = b, d && (d = d.apply(this, [
                this.min,
                this.max
        ...
        unsquish: function () {
            ...
            b ? (j = !a.staggerLines && !a.step && (r(g) ? [
                g
            ] : e < o(a.autoRotationLimit, 80) && a.autoRotation)) && p(j, function (a) {
                var b;
        ...
        getOffset: function () {
            ...
            if (k || a.isLinked) {
                ...
                [
                    h
                ] === a.labelAlign || a.labelAlign === 'center') && p(e, function (a) {
        ...
        render: function () {
            ...
            if (a.hasData() || g) {
                ...
                if (!a._addedPlotLB) p((d.plotLines || [
                ]).concat(d.plotBands || [
                ]), function (b) {
    ...
    ha.prototype.getTimeTicks = function (a, b, c, d) {
        ...
        if (r(b)) {
            ...
            i = new la(i + Ya(i));
            h = i[bb]();
            for (var d = i.getTime(), l = i[ab](), m = i[Ua](), n = !g || !!Za, q = (H.day + (g ? Ya(i)  : i.getTimezoneOffset() * 60000)) % H.day; d < c; ) e.push(d),
    ...
    ha.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        i = this.getLinearTickPositions(a, b, c);
         else if (a >= 0.08) for (var f = V(b), k, j, l, m, n, e = a > 0.3 ? [
            1,
            2,
            4
        ] : a > 0.15 ? [
    ...
    Xa.prototype = {
        ...
        runPointActions: function (a) {
            ...
            g && (e ? g.noSharedTooltip : g.directTouch) && f ? m = [
                f
            ] : (p(c, function (b) {
    ...
    u(x.Pointer.prototype, {
        ...
        pinchTranslateDirection: function (a, b, c, d, e, f, g, h) {
            ...
            B ? (t -= 0.8 * (t - g[k][0]), v || (x -= 0.8 * (x - g[k][1])), c())  : g[k] = [
                t,
                x
            ];
            p || (f[k] = o - n, f[m] = q);
    ...
    ob.prototype = {
        ...
        adjustMargins: function (a, b) {
            ...
            this.display && !d.floating && p([/(lth|ct|rth)/,
            /(rtv|rm|rbv)/,
            /(rbh|cb|lbh)/,
            /(lbv|lm|ltv)/], function (f, g) {
                ...
                - 1,
                - 1,
                1][g] * d[g % 2 ? 'x' : 'y'] + o(d.margin, 12) + b[g]))
            })
        },
        render: function () {
            var a = this,
    ...
    var Bb = x.CenteredSeriesMixin = {
        getCenter: function () {
            ...
            e[g] = (/%$/.test(h) ? [
                ...
                f,
                e[2]
            ][g] * parseFloat(h) / 100 : parseFloat(h)) + (a ? c : 0);
            e[3] > e[2] && (e[3] = e[2]);
            return e
        }
    },
    ...
    R.prototype = {
        ...
        setData: function (a, b, c, d) {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) p(a, function (a, b) {
                ...
                if (n && h > n) {
                    ...
                    a[c]
                ]), e.updateParallelArrays(j, c), m && r(j.name))) l.names[j.x] = j.name;
                xa(z[0]) && aa(14, !0);
                e.data = [
                ];
        ...
        generatePoints: function () {
            ...
            b = this.data = b;
            for (m = 0; m < g; m++) i = h + m,
            k ? (l[m] = (new f).init(this, [
                d[m]
            ].concat(ta(e[m]))), l[m].dataGroup = this.groupMap[m])  : (b[i] ? j = b[i] : a[i] !== y && (b[i] = j = (new f).init(this, a[i], d[m])), l[m] = j),
            l[m].index = i;
        ...
        translate: function () {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, k = i === 'between' || J(i), j = a.threshold, l = a.startFromThreshold ? j : 0, m, n, q, p, s = Number.MAX_VALUE, a = 0; a < g; a++) {
                ...
                aa(10);
                G.plotX = m = ca(F(t( - 100000, c.translate(w, 0, 0, 0, 1, i, this.type === 'flags')), 100000));
                ...
                G.plotY = n = typeof v === 'number' && v !== Infinity ? F(t( - 100000, e.translate(v, 0, 1, 0, 1)), 100000)  : y;
        ...
        drawPoints: function () {
            ...
            }, q = !!g.marker, a = r && n.enabled === y || n.enabled, p = g.isInside, a && J(e) && g.y !== null) if (a = g.pointAttr[g.selected ? 'select' : ''] || m, h = a.r, i = o(n.symbol, this.symbol), k = i.indexOf('url') ===
        ...
        getGraphPath: function (a, b, c) {
            ...
            p(a, function (g, j) {
                ...
                g.isNull && !r(b) && j > 0 ? i = !e.connectNulls : g.isNull && !b ? i = !0 : (j === 0 || i ? n = [
                    'M',
                    g.plotX,
                    g.plotY
                ] : d.getPointSpline ? n = d.getPointSpline(a, g, j)  : f ? (n = f === 1 ? [
                    'L',
                    n.plotX,
                    m
                ] : f === 2 ? [
    ...
    R.prototype.setStackedPoints = function () {
        ...
        !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (w = 0; w < d; w++) {
                ...
                s = m[s][v];
                if (u !== null) s.points[r] = s.points[this.index] = [
                    o(s.cum, g)
                ],
    ...
    wa = qa(R, {
        ...
        getPointSpline: function (a, b, c) {
            ...
            b = [
                'C',
                o(f.rightContX, f.plotX),
                o(f.rightContY, f.plotY),
                o(g, d),
                o(h, e),
                d,
                e
    ...
    wa = qa(R, {
        ...
        drawPoints: function () {
            ...
            p(a.points, function (h) {
                ...
                i ? (Oa(i), i.attr(k).attr(g) [b.pointCount <
    ...
    R.prototype.justifyDataLabel = function (a, b, c, d, e, f) {
        ...
        k = c.y + d.height - l;
        if (k > g.plotHeight) i ===
        'top' ? b.verticalAlign = 'bottom' : b.y = g.plotHeight - k,
        j = !0;
        if (j) a.placed = !f,
        a.align(b, null, e)
    };
    ...
    ga = x.TrackerMixin = {
        drawTrackerPoint: function () {
            ...
            f = function (a) {
                for (var c = a.target, d; c && !d; ) d = c.point,
                c = c.parentNode;
        ...
        drawTrackerGraph: function () {
            ...
            n = 'rgba(192,192,192,' + (fa ? 0.0001 : 0.002) + ')';

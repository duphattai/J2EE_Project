<%-- 
    Document   : main
    Created on : May 14, 2016, 12:18:30 PM
    Author     : Tai
--%>
...
<!--                                        <div class="row">
                ...
                <section class="sidebar">
                  ...
                  <!-- Sidebar user panel (optional) -->
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li id="quanlyvexe" class="treeview an">
                        ...
                        <li id="quanlytuyenxe" class="treeview an">
			...
			<li id="quanlyxe" class="treeview an">
                        ...
                        <li id="baocaodoanhthu" class="treeview an">
                            <a href="#"><i class="fa fa-link"></i> <span>Báo cáo doanh thu</span> <i class="fa fa-angle-left pull-right"></i></a>
                            <ul class="treeview-menu">
                                <li>            
    ...
    $(document).ready(function () {
        ...
        var admin = ["#taikhoan"];
        var nhanvien = ["#quanlyvexe", "#quanlychuyendi", "#quanlyxe", "#quanlytuyenxe", "#baocaodoanhthu"];
        var quanly = ["#quanlyvexe", "#quanlychuyendi", "#quanlyxe", "#quanlytuyenxe"];
